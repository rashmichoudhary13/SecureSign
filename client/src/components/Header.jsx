...
const Header = () => {
  ...
  return (
    <Container className='d-flex flex-column align-items-center justify-content-center text-center mt-5'>
      <Image src={assets.header_img} className='h-auto' roundedCircle style={{width: '20%'}}/>
        ...
        <p className='fs-4 ps-2 mb-4' style={{width: '40%'}}> Let's start with a quick product tour and we will have you up and running in no time!</p>
